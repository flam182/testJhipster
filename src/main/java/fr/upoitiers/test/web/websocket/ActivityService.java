package fr.upoitiers.test.web.websocket;

import fr.upoitiers.test.security.SecurityUtils;
import fr.upoitiers.test.web.websocket.dto.ActivityDTO;
...
import static fr.upoitiers.test.config.WebsocketConfiguration.IP_ADDRESS;
