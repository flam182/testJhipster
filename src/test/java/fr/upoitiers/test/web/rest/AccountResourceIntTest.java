...
import fr.upoitiers.test.JhipsterTestApp;
import fr.upoitiers.test.config.JHipsterProperties;
import fr.upoitiers.test.domain.Authority;
import fr.upoitiers.test.domain.User;
import fr.upoitiers.test.repository.AuthorityRepository;
import fr.upoitiers.test.repository.UserRepository;
import fr.upoitiers.test.security.AuthoritiesConstants;
